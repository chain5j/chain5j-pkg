...
// Used for testing
func newEmpty() *Trie {
	trie, _ := New(types.Hash{}, NewDatabase(memorydb.New()))
	return trie
}
...
func TestMissingRoot(t *testing.T) {
	trie, err := New(types.HexToHash("0beec7b5ea3f0fdbc95d0dd47f3c5bc275da8a33"), NewDatabase(memorydb.New()))
	if trie != nil {
...
func tempDB() (string, *Database) {
	...
	diskdb := memorydb.NewWithCap(256)
	if err != nil {
