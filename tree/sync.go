...
import (
	...
	prque "github.com/chain5j/chain5j-pkg/queue/preque"
...
func NewSync(root types.Hash, database database.KeyValueReader, callback LeafCallback, bloom *SyncBloom) *Sync {
	ts := &Sync{
		database: database,
