...
type Sync struct {
	database kvstore.KeyValueReader  // Persistent database to check for existing entries
...
func NewSync(root types.Hash, database kvstore.KeyValueReader, callback LeafCallback, bloom *SyncBloom) *Sync {
	ts := &Sync{
		database: database,
...
func (s *Sync) Commit(dbw kvstore.Batch) error {
